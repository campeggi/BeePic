...
#                             -------------------
#        begin                : 2013-03-01
#        copyright            : (C) 2013 by Alessandro Perego
#        email                : alper78@alice.it
# ***************************************************************************/
# 
#/***************************************************************************
# *                                                                         *
...
# translation
SOURCES = geolocatephotos.py ui_geolocatephotos.py __init__.py geolocatephotosdialog.py
#TRANSLATIONS = i18n/geolocatephotos_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = geolocatephotos

PY_FILES = geolocatephotos.py geolocatephotosdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_geolocatephotos.py
